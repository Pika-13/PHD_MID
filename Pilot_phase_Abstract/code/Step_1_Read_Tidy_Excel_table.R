...
compared_RCT <- janitor::clean_names(
  read_xlsx("database/Revised_Data_original_Fariba_2025_10_30.xlsx",col_names = TRUE)[-1, ]) %>% 
  ...
  mutate(type_of_study_1_ep_sup_non_inf = case_when(
      protocol==1 ~ NA_character_,
  ...
  mutate(
    type_of_study_1_ep_sup_non_inf = factor(type_of_study_1_ep_sup_non_inf,
                                       levels = c("0", "1", "3", "nm"),
                                       labels = c("Superiority trial", "Non-inferiority trial",
                                                  "Equivalence trial", "Not mentioned"))) %>% 
  select(-type_of_study) %>%
  mutate(type_of_study_2_ep_sup_non_inf = case_when(
    protocol==1 ~ NA_character_,
    is.na(type_of_study_2ep)~ NA_character_,
    type_of_study_2ep =="na" ~ NA_character_,
    type_of_study_2ep =="nm" ~"nm",
    type_of_study_2ep =="0"  ~ "0", 
    type_of_study_2ep =="1"  ~ "1",
    type_of_study_2ep == "3"  ~ "3")) %>% 
  mutate(
    type_of_study_2_ep_sup_non_inf = factor(type_of_study_2_ep_sup_non_inf,
                                       levels = c("0", "1", "3", "nm"),
                                       labels = c("Superiority trial", "Non-inferiority trial",
                                                  "Equivalence trial", "Not mentioned"))) %>% 
  select(-type_of_study_2ep) %>%
  mutate(
    non_inf_margin_protocol= case_when(
      is.na(type_of_study_protocol_1st_ep)~ NA_character_,
      type_of_study_protocol_1st_ep %in% c("0", "na", "nm") ~ NA_character_,
    type_of_study_protocol_1st_ep == "1" & is.na(definition_of_non_inf_margin_protocol) ~ "0",
    type_of_study_protocol_1st_ep == "1" & definition_of_non_inf_margin_protocol %in% c("na", "nm") ~ "0",
    type_of_study_protocol_1st_ep == "1" & definition_of_non_inf_margin_protocol != "na" 
  ...
  mutate(
    ...
    definition_of_non_inf_margin_protocol = case_when(
      ...
      type_of_study_protocol_1st_ep %in% c("0", "na", "nm") ~ NA_character_,
      type_of_study_protocol_1st_ep=="1" &  definition_of_non_inf_margin_protocol %in% c("na", "nm") ~ NA_character_,
      type_of_study_protocol_1st_ep=="1" &  is.na(definition_of_non_inf_margin_protocol) ~ NA_character_,
      type_of_study_protocol_1st_ep=="1" & 
  ...
  mutate(
    ...
    study_type_mentioned = factor(study_type_mentioned,
      levels = c("0", "1"),
      labels = c("No", "Yes")),
    type_of_study_1_ep_sup_non_inf = case_when(
      protocol=="Protocol" ~ NA_character_,
      protocol== "Not a protocol" & is.na(type_of_study_1_ep_sup_non_inf) ~"Not mentioned",
      study_type_mentioned== "Yes" & type_of_study_1_ep_sup_non_inf =="3"~"Equivalence trial",
      type_of_study_1_ep_sup_non_inf == "na" ~"Not mentioned",
      type_of_study_1_ep_sup_non_inf == "nm" ~"Not mentioned",
      study_type_mentioned== "Yes" & type_of_study_1_ep_sup_non_inf=="Non-inferiority trial"~"Non-inferiority trial",
      study_type_mentioned== "No" ~"Not mentioned",
      study_type_mentioned== "Yes" & type_of_study_1_ep_sup_non_inf=="Superiority trial"~"Superiority trial"
      ),
    type_of_study_1_ep_sup_non_inf = factor(type_of_study_1_ep_sup_non_inf,
  ...
  mutate(
    ...
    study_type_mentioned_protocol= factor(study_type_mentioned_protocol,
                                          levels = c(0,1),
                                          labels = c("No", "Yes")),
    type_of_study_1_ep_sup_non_inf_protocol = case_when(
      protocol_published=="Neither protocol nor registry" ~ NA_character_,
      type_of_study_protocol_1st_ep == "na" ~"Not mentioned",
      type_of_study_protocol_1st_ep == "nm" ~"Not mentioned",
      is.na(study_type_mentioned_protocol)~"Not mentioned",
      study_type_mentioned_protocol== "Yes" & type_of_study_protocol_1st_ep =="3"~"Equivalence trial",
      study_type_mentioned_protocol== "Yes" & type_of_study_protocol_1st_ep =="1"~"Non-inferiority trial",
      study_type_mentioned_protocol== "Yes" & type_of_study_protocol_1st_ep=="0"~"Superiority trial",
      study_type_mentioned_protocol== "No" ~"Not mentioned")) %>% 
  mutate(
    type_of_study_1_ep_sup_non_inf_protocol = factor(type_of_study_1_ep_sup_non_inf_protocol,
                                                levels = c("Superiority trial","Non-inferiority trial", 
                                                           "Equivalence trial", "Not mentioned"),
                                                labels = c("Superiority trial","Non-inferiority trial", 
                                                           "Equivalence trial", "Not mentioned"))) %>% 
  select(-type_of_study_protocol_1st_ep) %>%
  mutate(type_of_study_2_ep_sup_non_inf_protocol = case_when(
      protocol_published=="Neither protocol nor registry" ~ NA_character_,
      type_of_study_protocol_2nd_ep == "na" ~"Not mentioned",
      type_of_study_protocol_2nd_ep == "nm" ~"Not mentioned",
      is.na(type_of_study_protocol_2nd_ep)~"Not mentioned",
      study_type_mentioned_protocol== "Yes" & type_of_study_protocol_2nd_ep =="3"~"Equivalence trial",
      study_type_mentioned_protocol== "Yes" & type_of_study_protocol_2nd_ep =="1"~"Non-inferiority trial",
      study_type_mentioned_protocol== "Yes" & type_of_study_protocol_2nd_ep=="0"~"Superiority trial",
      study_type_mentioned_protocol== "No" ~"Not mentioned")) %>%
  mutate(type_of_study_2_ep_sup_non_inf_protocol = factor(type_of_study_2_ep_sup_non_inf_protocol,
                                              levels = c("Superiority trial","Non-inferiority trial", 
                                                         "Equivalence trial", "Not mentioned"),
                                              labels = c("Superiority trial","Non-inferiority trial", 
                                                         "Equivalence trial", "Not mentioned"))) %>%
  select(-type_of_study_protocol_2nd_ep) %>% 
  mutate(
  ...
  mutate(
    significance_considered = case_when(
      is.na(significance_considered) ~ NA_character_,
      significance_considered=="na"~ NA_character_,
  ...
  select(article_id, title, publication_year, 
         ...
         study_type_mentioned, type_of_study_1_ep_sup_non_inf, 
         ...
         study_type_mentioned_protocol, type_of_study_1_ep_sup_non_inf_protocol,
...
#saving excel and csv
write_csv(included_from_compared_RCT, "database/csv_files_R_coding/Data_included_from_compared_RCT_2025_11_02.csv")
write_xlsx(included_from_compared_RCT, "database/csv_files_R_coding/Data_included_from_compared_RCT_2025_11_02.xlsx")
