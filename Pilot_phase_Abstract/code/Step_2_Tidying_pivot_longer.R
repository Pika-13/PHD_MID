...
included_from_compared_RCT <- read_csv("database/csv_files_R_coding/Data_included_from_compared_RCT_2025_11_02.csv") 
#naming RCT_publications and 
RCT_publications <- included_from_compared_RCT %>% 
  filter(protocol == "Not a protocol")
write_csv(RCT_publications, "database/csv_files_R_coding/RCT_publications_2025_11_02.csv")

RCT_protocols_without_publication <- included_from_compared_RCT %>% 
  filter(protocol == "Protocol")
write_csv(RCT_protocols_without_publication, "database/csv_files_R_coding/RCT_protocols_without_publication_2025_11_02.csv")
...
write_csv(RCT_matched_publications_protocols, "database/csv_files_R_coding/RCT_matched_publications_protocols_2025_11_02.csv")
...
write_csv(long_RCT_matched_publications_protocols, "database/csv_files_R_coding/long_RCT_matched_publications_protocols_2025_11_02.csv") 
...
long_RCT_matched_publications_protocols$study_type_mentioned <- factor(long_RCT_matched_publications_protocols$study_type_mentioned, 
                                                  levels = c("Yes", "No"))
long_RCT_matched_publications_protocols$type_of_study_1_ep_sup_non_inf <- factor(long_RCT_matched_publications_protocols$type_of_study_1_ep_sup_non_inf, 
                                                                            levels = c("Superiority trial", "Non-inferiority trial",
                                                                                       "Equivalence trial", "Not mentioned"))
long_RCT_matched_publications_protocols$type_of_study_2_ep_sup_non_inf <- factor(long_RCT_matched_publications_protocols$type_of_study_2_ep_sup_non_inf, 
                                                                                 levels = c("Superiority trial", "Non-inferiority trial",
                                                                                            "Equivalence trial", "Not mentioned"))
...
long_RCT_matched_publications_protocols$conclusion_of_authors <- factor(
  ...
  levels =  c("Favorable to intervention"," Unfavorable to intervention", "Not mentioned"))

#save
write_csv(long_RCT_matched_publications_protocols,"database/csv_files_R_coding/long_RCT_matched_publications_protocols_2025_11_02.csv")
write_xlsx(long_RCT_matched_publications_protocols,"database/csv_files_R_coding/long_RCT_matched_publications_protocols_2025_11_02.xlsx")
...
long_231_RCT_protocols_and_or_trials <-
  rbind(long_RCT_matched_publications_protocols,
        ...
        RCT_publications %>% 
          ...
          select(names(long_RCT_matched_publications_protocols)) )
write_csv(long_231_RCT_protocols_and_or_trials, "database/csv_files_R_coding/long_231_RCT_protocols_and_or_trials_2025_11_02.csv")
